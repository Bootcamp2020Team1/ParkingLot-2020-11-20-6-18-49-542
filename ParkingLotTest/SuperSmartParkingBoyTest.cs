...
namespace ParkingLotCLITest
{
    public class SuperSmartParkingBoyTest
    {
        ...
        [Fact]
        public void Should_Super_Smart_Parking_Boy_Fetch_No_Cars_Given_The_Wrong_Ticket()
        {
            //given
            var expectedCar = new Car("N98245");
            var parkingBoy = new SuperSmartParkingBoy(new List<ParkingLot>() { new ParkingLot() });
        ...
        public void Should_Super_Smart_Park_No_Car_Given_Parking_Lot_Has_No_Position()
        {
            //given
            var parkedCar = new Car("N98245");
            var parkingBoy = new SuperSmartParkingBoy(new List<ParkingLot>() { new ParkingLot(1) });
        ...
        {
            //given
            var parkingBoy = new SuperSmartParkingBoy(new List<ParkingLot>() { new ParkingLot(0) });
        ...
        public void Should_Return_True_Given_Parking_Lot_Exist_When_Remove_ParkingLot()
        {
            ...
            var parkingBoy = new SuperSmartParkingBoy(new List<ParkingLot>() { parkingLot });
